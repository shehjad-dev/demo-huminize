...
const page = (props: Props) => {
    return (
        ...
        <form className='bg-slate-500 h-[100vh]'>
            <p className='text-lg text-white font-bolt p-10'>Huminize text</p>
            <div className="w-[80vw] mb-4 border border-gray-200 mx-10 rounded-lg bg-gray-50 dark:bg-gray-700 dark:border-gray-600">
            ...
            <button type="submit" className="inline-flex items-center px-5 mx-10 py-2.5 text-sm font-medium text-center text-white bg-blue-700 rounded-lg focus:ring-4 focus:ring-blue-200 dark:focus:ring-blue-900 hover:bg-blue-800">
                Huminize Text
            </button>
        </form>
